    ...
    <div>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-light my-4 text-red-600">Best Solutions-Best Growth.</h2>
          <hr className="w-48 h-1 mx-auto my-4 border-0 rounded bg-red-600" />
        ...
        <div className="flex flex-wrap justify-center -mx-4">
          <div className="w-full sm:w-1/3 px-4 mb-8">
            <div className="flex flex-col items-center text-center p-6 bg-white shadow-lg rounded-lg h-48">
              <div className="mb-4">
