        ...
        <footer className="bg-gray-700 text-white">
            <div className="container mx-auto px-4 py-8">
                ...
                <div className="w-full md:w-1/4 px-4 mb-6 md:mb-0">
                        ...
                        <div className='pl-4 md:pl-2'>
                            <ul className='list-disc'>
                             <Link to="/web-development-designing">   <li>Web Development</li> </Link>
                             <Link to="/software-development">   <li>Software Development</li></Link>
                             <Link to="/e-commerce">   <li>E-Commerce App</li></Link>
                             <Link to="/mobile-app">   <li>Mobile App Development</li></Link>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="w-full md:w-1/4 px-4 mb-6 md:mb-0">
                        ...
                        <div className='pl-4 md:pl-2'>
                            ...
                            <Link to="/voice-calls">   <li>Voice Calls</li></Link>
                            <Link to="/whatsapp-apis">    <li>WhatsApp Apis</li></Link>
                            <Link to="/whatsapp-messages">     <li>WhatsApp Messages</li></Link>
                            </ul>
                        </div>
                    </div>
                    <div className="w-full md:w-1/4 px-4 mb-6 md:mb-0">
                        ...
                        <div className='pl-4 md:pl-2'>
                            <ul className='list-disc'>
                            <Link to="/maintenance">   <li>Maintenance Services</li></Link>
                            <Link to="/logo-designing">   <li>Logo Designing</li></Link>
                            </ul>
                        </div>
                    </div>
                    <div className="w-full md:w-1/4 px-2">
                        <h3 className="text-lg md:text-xl font-semibold mb-4">Contact Information</h3>
                        <p><i className="fas fa-map-marker-alt"></i> Nathuram SHO Street Old, Sabzi Mandi,</p>
                        <p>Shubhash Chowk, Sirsa (125055), Haryana</p>
                        <p><i className="fas fa-phone"></i> +91-9254147455</p>
                ...
                <div className="flex flex-col md:flex-row justify-between items-center  py-1 mt-4">
                    <p className=" text-center md:text-left">&nbsp; &copy; 2013 All Rights Reserved.</p>
                    <p><a href="#" className="bg-gray-200 hover:bg-gray-300 p-2 rounded text-black"><i className="fas fa-arrow-circle-up"></i> Back to top </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
                </div>
            </div>
        </footer>
    );
